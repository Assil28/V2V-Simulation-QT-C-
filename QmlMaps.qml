...
Rectangle {
    ...
    Component {
        id: carComponent
        MapQuickItem {
            property string color: "#000000"  // Propriété pour la couleur
            ...
            sourceItem: Image {
                ...
                // Ajouter un ColorOverlay pour colorer l'image de la voiture
                layer.enabled: true
                layer.effect: ShaderEffect {
                    property color overlayColor: parent.parent.color
                    ...
                    fragmentShader: "
                        ...
                        void main() {
                            vec4 pixelColor = texture2D(source, qt_TexCoord0);
                            gl_FragColor = vec4(overlayColor.rgb, pixelColor.a);
                        }"
                }
            }
        }
